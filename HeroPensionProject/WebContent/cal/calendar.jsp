...
/* 		
		...
		public String makeTable(int year, int month, int day, List<reservDto> list){
			...
			for(reservDto dto: list){
				if((dto.getDate_res().substring(0,3)+dto.getDate_res().substring(6,7)+dto.getDate_res().substring(9,10)).equals(dates)){
					s += "<tr bgcolor='pink'>";
					s += "<td>";
					s += "<a href='calendarDetail.jsp?seq=" + dto.getSeq_room() + "'>";
					s += "<font style='font-size:8; color:red'>";
					s += dot3(dto.getSeq_room()+"");
					s += "</font>";
					s += "</a>";
					s += "</td>";
					s += "</tr>";
